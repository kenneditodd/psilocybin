...
```{r CCA_heatmap}
# formula
form <- ~0 + group + treatment + dose + timepoint +  sex + log2.lib + weight_at_treatment + RIN
...
form <- ~ (1|group) + (1|sex) + weight_at_treatment + log2.lib + RIN
...
dge.filtered.norm$samples <- cbind(dge.filtered.norm$samples, meta[,10:19])
