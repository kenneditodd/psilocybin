...
# save
path <- "../../results/prefiltering_QC/JSD_heatmap"
pdf(paste0(path,".pdf"), width = 15, height = 15)
...
for (dim in dims) {
  ...
  for (numGenes in topGenes) {
    ...
    path <- paste0("../../results/prefiltering_QC/MDS_top_",
