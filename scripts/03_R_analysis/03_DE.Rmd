...
myContrasts <- c("psilo.low.8h - sal.8h",
                 ...
                 "sal.7d - sal.24h",
                 "sal.7d - sal.8h",
                 "psilo.low.24h - psilo.low.8h",
                 "psilo.low.7d - psilo.low.24h",
                 "psilo.low.7d - psilo.low.8h",
                 "psilo.high.24h - psilo.high.8h",
                 "psilo.high.7d - psilo.high.24h",
                 "psilo.high.7d - psilo.low.8h")
myContrasts2 <- c("psilo.low.8h.F - sal.8h.F",
                 "psilo.low.24h.F - sal.24h.F",
                 "psilo.low.7d.F - sal.7d.F",
                 "psilo.high.8h.F - sal.8h.F",
                 "psilo.high.24h.F - sal.24h.F",
                 "psilo.high.7d.F - sal.7d.F",
                 "sal.24h.F - sal.8h.F",
                 "sal.7d.F - sal.24h.F",
                 "sal.7d.F - sal.8h.F",
                 "psilo.low.8h.M - sal.8h.M",
                 "psilo.low.24h.M - sal.24h.M",
                 "psilo.low.7d.M - sal.7d.M",
                 "psilo.high.8h.M - sal.8h.M",
                 "psilo.high.24h.M - sal.24h.M",
                 "psilo.high.7d.M - sal.7d.M",
                 "sal.24h.M - sal.8h.M",
                 "sal.7d.M - sal.24h.M",
                 "sal.7d.M - sal.8h.M")
```
...
df$comparison <- gsub(" - ", " vs ", df$comparison)
...
# save
path <- paste0(out, model, "/DEG_tables/DEG_comparison_FDRq_",format(pval, nsmall = 2),
               "_LFC_", format(my.lfc, nsmall = 2),".pdf")
pdf(path, width = 8, height = 9)

# plot
pheatmap::pheatmap(round(df, digits = 0),
