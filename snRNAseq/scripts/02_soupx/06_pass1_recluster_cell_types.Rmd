...
neurons <- subset(mouse.annotated, 
                  individual_clusters == c("Neurons 1", "Neurons 2", 
                                           "Neurons 3", "Neurons 4", 
                                           "Neurons 5", "Neurons 6", 
                                           "Neurons 7", "Neurons 8", 
...
neurons <- CreateSeuratObject(counts, meta.data = neurons@meta.data[,c(1,4:27)])
...
```{r}
remove(neurons, neurons.unannotated, auto_markers, top5)
gc()
```
...
# subset astrocytes
astrocytes <- subset(mouse.annotated, 
                  individual_clusters == "Astrocytes")
...
saveRDS(object = barcodes,
        file = paste0("../../rObjects/", filtering_method, "_recluster_astrocytes_barcodes_to_remove.rds"))
