...
mouse.annotated <- readRDS(
  paste0(project_dir, "/rObjects/", filtering_method, "_recluster_neurons_pass2_annotated_seurat_obj.rds"))
...
DE_within_each_cluster(
  obj = mouse.annotated,
  outDir = out_dir,
  clusterCol = "azimuth_subclass_filtered",
  groupCol = group_col,
  method = de_method,
  group1 = group1,
  group2 = group2,
