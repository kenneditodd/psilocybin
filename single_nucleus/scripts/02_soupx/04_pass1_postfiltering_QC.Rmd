...
subtitle: "Pass 1: Postfiltering QC"
author: "Kennedi Todd"
date: "11/07/2025"
output:
  html_document:
...
## Load data
```{r load_data}
mouse.filtered <- readRDS("../../rObjects/pass1_filtered_seurat_obj.rds")
```
...
```{r save_postfiltering_cells_per_sample}
# save
...
# save
pdf(paste0(out, "filtering_QC/density_curves_filtered.pdf"), width = 9, height = 8)
grid <- grid.arrange(grobs = plots, layout_matrix = layout)
