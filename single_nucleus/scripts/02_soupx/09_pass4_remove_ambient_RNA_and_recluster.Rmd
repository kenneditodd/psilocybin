---
title: "Psi1 snRNAseq"
subtitle: "Pass 4: SoupX and Recluster"
author: "Kennedi Todd"
date: "11/13/2025"
output:
  html_document:
...
```{r}
Idents(mouse_annotated) <- "annotated_clusters"
mouse_annotated <- FindSubCluster(
  object = mouse_annotated,
  cluster = "Neurons-Gad2",
  subcluster.name = "gad2_clusters",
  graph.name = "SCT_snn",
  resolution = 0.7
)
Idents(mouse_annotated) <- "gad2_clusters"

# set level
mouse_annotated$gad2_clusters <- factor(mouse_annotated$gad2_clusters,
                                  levels = c("Astrocytes",
                                             "Choroid",
                                             "Microglia",
                                             "Neurons-Gad2_0",
...
DotPlot(mouse_annotated,
              features = c("Gad1","Gad2","Pvalb","Lamp5","Vip","Sst",
                           "Drd1","Drd2","Drd3"),
              cols = "RdYlBu",
              assay = "RNA") +
  coord_flip() +
...
```{r assign_identities}
new_cluster_names <- c(
  "Neurons-Gad2_0" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_1" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_2" = "Inh_Pvalb",
  "Neurons-Gad2_3" = "Inh_Vip",
  "Neurons-Gad2_4" = "Inh_Sst",
  "Neurons-Gad2_5" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_6" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_7" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_8" = "Inh_Lamp5",
  "Neurons-Gad2_9" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_10" = "Inh_Pvalb",
  "Neurons-Gad2_11" = "Inh_Sst",
  "Neurons-Gad2_12" = "Inh_Pvalb",
  "Neurons-Gad2_13" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_14" = "Inh_Sst",
  "Neurons-Gad2_15" = "Inh_Pvalb",
  "Neurons-Gad2_16" = "Inh_Vip",
  "Neurons-Gad2_17" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_18" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_19" = "Inh_Drd1_Drd2",
  "Neurons-Gad2_20" = "Inh_Pvalb",
  "Neurons-Gad2_21" = "Inh_Drd1_Drd2"
)

# set new idents
Idents(mouse_annotated) <- "gad2_clusters"
mouse_annotated <- RenameIdents(mouse_annotated, new_cluster_names)
mouse_annotated$gad2_clusters_annotated <- Idents(mouse_annotated)

# set level
mouse_annotated$gad2_clusters_annotated <- factor(mouse_annotated$gad2_clusters_annotated,
                                  levels = c("Astrocytes",
                                             "Choroid",
                                             "Microglia",
                                             "Inh_Drd1_Drd2",
                                             ...
                                             "Oligodendrocytes",
                                             "OPCs"))
Idents(mouse_annotated) <- "gad2_clusters_annotated"
```

## Annotated UMAP
```{r}
DimPlot(mouse_annotated, 
        group.by = "gad2_clusters_annotated",
        cols = c(rep("gray",3), "red","gold","green","blue","violet",
                 "gray","gray","gray","gray"),
        shuffle = TRUE)
```
...
```{r}
DotPlot(mouse_annotated,
              features = c("Gad1","Gad2","Drd1","Drd2","Drd3","Lamp5","Pvalb",
                           "Sst","Vip"),
              cols = "RdYlBu",
              assay = "RNA") +
  coord_flip() +
...
mouse_annotated <- FindSubCluster(
  object = mouse_annotated,
  cluster = "Neurons-Slc17a7",
  subcluster.name = "slc17a7_clusters",
  graph.name = "SCT_snn",
  resolution = 0.3
)

# set level
mouse_annotated$slc17a7_clusters <- factor(mouse_annotated$slc17a7_clusters,
                                  levels = c("Astrocytes",
                                             "Choroid",
                                             "Microglia",
                                             "Inh_Drd1_Drd2",
                                             ...
                                             "Oligodendrocytes",
                                             "OPCs"))
Idents(mouse_annotated) <- "slc17a7_clusters"

DimPlot(mouse_annotated, 
        shuffle = TRUE,
        cols = c(rep("gray",8), "black", "maroon","firebrick1", "gold", "orange","green",
                 "forestgreen", "cyan", "steelblue", "blue", "purple", "violet","pink",
                 "tan","chocolate4", "gray","gray"))
```

## Marker dot plot
```{r}
DotPlot(mouse_annotated,
              features = c("Slc17a7", "Cux1", "Cux2", "Bcl11b", "Tle4",
                           "Rorb", "Glis3"),
              cols = "RdYlBu",
              assay = "RNA") +
  coord_flip() +
...
## Marker heatmap
```{r marker_heatmaps, message=FALSE}
marker_genes <- c("Slc17a7", "Cux2", "Foxp2", "Prox1")

# create 4 FeaturePlots
...
# plot together
all_plots <- c(fplots)
layout <- matrix(1:4, nrow = 2, ncol = 4, byrow = TRUE)
...
saveRDS(auto_markers, "auto_markers.rds", compress = FALSE)
```

## Assign idetities
```{r assign_identities}
new_cluster_names <- c(
  "Neurons-Slc17a6" = "Exc_Slc17a6",
  "Neurons-Slc17a7_0" = "Exc_Slc17a7_Foxp2",
  "Neurons-Slc17a7_1" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_2" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_3" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_4" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_5" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_6" = "Exc_Slc17a7_Prox1",
  "Neurons-Slc17a7_7" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_8" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_9" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_10" = "Exc_Slc17a7_Foxp2",
  "Neurons-Slc17a7_11" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_12" = "Exc_Slc17a7_Cux2",
  "Neurons-Slc17a7_13" = "Exc_Slc17a7_Foxp2"
)

# set new idents
Idents(mouse_annotated) <- "slc17a7_clusters"
mouse_annotated <- RenameIdents(mouse_annotated, new_cluster_names)
mouse_annotated$slc17a7_clusters_annotated <- Idents(mouse_annotated)

# set level
mouse_annotated$slc17a7_clusters_annotated <- factor(mouse_annotated$slc17a7_clusters_annotated,
                                  levels = c("Astrocytes",
                                             "Choroid",
                                             "Microglia",
                                             "Exc_Slc17a6",
...
# overwrite main annotations
mouse_annotated$annotated_clusters <- mouse_annotated$slc17a7_clusters_annotated
Idents(mouse_annotated) <- "annotated_clusters"

# save
saveRDS(mouse_annotated, 
        file = paste0( "../../rObjects/pass4_annotated_subtypes_seurat_obj.rds"),
        compress = FALSE)
```
...
cluster_colors <- c(
  ...
  # Excitatory (blues)
  "Exc_Slc17a6"          = "#2C3E8F",
  "Exc_Slc17a7_Cux2"     = "#0072B2",
  "Exc_Slc17a7_Foxp2"    = "#56B4E9",
  "Exc_Slc17a7_Prox1"    = "#9AD0F3",
  
  # Inhibitory (purples/magentas)
  "Inh_Drd1_Drd2"        = "#882E72",
  "Inh_Lamp5"            = "#AA4499",
  "Inh_Pvalb"            = "#CC79A7",
  "Inh_Sst"              = "#D58BC8",
  "Inh_Vip"              = "#8C6BB1",
  
  # Oligodendrocytes / OPCs (blue-greens)
...
pdf(paste0(out, "markers/annotated_auto_top3_markers.pdf"), width = 10, height = 10)
dot
dev.off()
remove(dot, top3)
```
...
canonical_markers <- c(
  ...
  "Syt1", "Snap25",                                   # Pan-neuron
  "Slc17a6", "Slc17a7",                               # Exc
  "Cux2", "Foxp2", "Prox1",                           # Exc
  "Gad1", "Gad2",                                     # Inh
  "Drd1","Drd2","Lamp5","Pvalb","Sst","Vip",          # Inh
...
## Marker heatmap
```{r marker_heatmaps}
marker_genes <- c("Snap25", "Gad2", "Drd1","Lamp5", "Vip", "Sst", "Pvalb",
                  "Slc17a6", "Slc17a7", "Cux2", "Foxp2", "Prox1")
...
# Save as PDF
path <- paste0(out, "markers/umap_heatmap_neuronal_markers.pdf")
...
saveRDS(mouse_downsample, 
        file = "../../rObjects/pass4_downsampled_annotated_subytypes_seurat_obj.rds",
        compress = FALSE)
```
...
colNames <- colNames[c(31:36,2:27)]
...
cluster_hex <- "#d55c00|#F0E442|#000000|#2C3E8F|#0072B2|#56B4E9|#9AD0F3|#882E72|#AA4499|#CC79A7|#D58BC8|#8C6BB1|#009E73|#7FCDBB"
