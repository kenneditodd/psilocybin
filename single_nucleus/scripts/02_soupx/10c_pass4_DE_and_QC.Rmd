...
for (i in files) {
  ...
  # read table
  df <- read.table(paste0(out, "DEGs_MAST_pct_0.6/DEG_tables/", i),
                   sep = "\t", 
                   header = TRUE)
  ...
  # save
  write.table(x = df, 
              file = paste0(out, "DEGs_MAST_pct_0.6_protein_only/DEG_tables/", i), 
              sep = "\t", 
              quote = FALSE, 
              row.names = FALSE)
}
...
for (i in files) {
  ...
  # save
  out_dir <- paste0(out, "DEGs_MAST_pct_0.6_protein_only/DEG_tables/")
  write.table(x = df, 
              file = paste0(out_dir, i), 
              sep = "\t", 
              quote = FALSE, 
              row.names = FALSE)
  
  # filter by adjusted p-value and LFC
