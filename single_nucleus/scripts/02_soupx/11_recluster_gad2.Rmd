---
title: "Psi1 snRNAseq"
subtitle: "Recluster Gad2 Neurons"
author: "Kennedi Todd"
date: "11/13/2025"
output:
  html_document:
...
out <- paste0(out, "recluster_gad2_neurons/")
...
```{r subset_neurons}
# subset neurons
sub <- subset(mouse_annotated, annotated_clusters == "Neurons-Gad2")
...
saveRDS(neurons_merged, 
        file = "../../rObjects/recluster_neurons_pass1_pca_seurat_obj.rds",
        compress = FALSE)
gc()
```
...
saveRDS(neurons_unannotated, 
        file = "../../rObjects/recluster_gad2_neurons_pass1_unannotated_seurat_obj.rds",
        compress = FALSE)
```
...
subtypes <- c("Foxp1", "Drd2", "Adora2a", "Drd1", "Ebf1", "Sv2b",
              "Vip", "Lamp5", "Pvalb", "Sst", "Drd3", "Ppp1r1b")
...
neurons_unannotated <- PercentageFeatureSet(
  ...
  features = c("Foxp1","Gpr88","Ppp1r1b","Rgs9","Rasgrp2"),
  col.name = "MSNs"
)
...
neurons_unannotated <- PercentageFeatureSet(
  object = neurons_unannotated,
  features = c("Drd1","Tac1","Pdyn","Ebf1"),
  col.name = "D1-MSNs"
)
...
d1 <- DotPlot(neurons_unannotated,
              features = c("Foxp1","Drd2","Penk", "Adora2a", "Drd1", "Tac1", 
                           "Pvalb", "Fign","Sst", "Lama4","Vip", "Lamp5"),
              cols = "RdYlBu",
              assay = "RNA") +
...
pdf(paste0(out, "markers/unannotated_subytpes_dot_plot.pdf"), 
    width = 10, height = 6)
d1
dev.off()
remove(d1)
...
new_cluster_names <- c(
  "0" = "Adora2a Drd2",      # iSPNs
  "1" = "Pvalb",
  "2" = "Sst",
  "3" = "Drd1",
  "4" = "Adora2a Drd2",      # iSPNs
  "5" = "?Drd1?",
  "6" = "Drd1",
  "7" = "", 
  "8" = "",
...
saveRDS(neurons_annotated, 
        file = "../../rObjects/recluster_gad2_neurons_pass1_annotated_seurat_obj.rds"),
        compress = FALSE)
```
...
makeShinyApp(obj = shiny.obj, 
             scConf = sc.config, 
             gene.mapping = TRUE,
             shiny.title = "Psi1 snRNAseq Gad1+ Gad2+ Reclustered")
